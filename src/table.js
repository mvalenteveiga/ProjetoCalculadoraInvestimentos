...
export const createTable = (columnsArray, dataArray, tableId) => {
  if (
    ...
    throw new Error(
      "Para a correta execução, precisamos de um array para as colunas, outro com as informações das linhas e também o id do elemento selecionado"
    );
  }
...
function createTableHeader(tableReference, columnsArray) {
  ...
  tableHeaderRefecence.appendChild(headerRow);
}
